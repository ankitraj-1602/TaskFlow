...
//       const senderEmail = process.env.EMAIL_FROM_EMAIL || 'noreply@taskflow.dev';
//       const senderName = process.env.EMAIL_FROM_NAME || 'TaskFlow';
...
class EmailService {
  ...
  async sendEmail({ to, subject, html }) {
    ...
    try {
      ...
      // ❌ Error log — includes subject so you can trace which email failed
